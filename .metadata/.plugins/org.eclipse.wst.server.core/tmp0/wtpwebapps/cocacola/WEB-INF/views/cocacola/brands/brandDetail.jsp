...
<c:if test="${not empty brand.youtubeVideoId}">
  <div class="productvideodesc">
    <h1>비디오</h1>
    <p>${brand.videoDescription}</p>

    <div class="productvideo" id="videoBox">
        <img src="${pageContext.request.contextPath}/cocacola/images/${brand.videoThumbnailUrl}" 
             alt="${brand.videoThumbnailUrl}" />
      <button class="play-btn" onclick="playVideo('${brand.youtubeVideoId}')">▶</button>
    </div>
  </div>
</c:if>
